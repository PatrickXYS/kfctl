...
params + {
  components+: {
    ...
    unit_tests+: {
      name: 'xyshow-kubeflow-kfctl-release-111-2222',
      namespace: 'kubeflow-test-infra',
      prow_env: 'JOB_NAME=kubeflow-kfctl-aws-utest,JOB_TYPE=presubmit,PULL_NUMBER=111,REPO_NAME=kfctl,REPO_OWNER=PatrickXYS,BUILD_NUMBER=2222',
